                ...
                <table>
                    <tr>
                        ...
                        <td rowspan="2" style="text-align: right;">
                            ...
                            <br />
                            <span
                                style="color: #fff; font-family: sans-serif; font-size: 45px; position: absolute; right: 16%; top: 50px;">CBU
            ...
            <div class="col-xs-12" style="margin: 0 auto; float: none; min-width: 1105px;">
                <div class="col-xs-12"
                    ...
                    <img style="margin-top:12px; float: left; max-width: 45%;"
                        src="../prodconfigmedia/GuidedSell/CBU_Mailbox_dims.png" />
                ...
                <div>
                    <table id="tblMain" class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td class="questions" colspan="2"><b>Select your CBU type:</b>
                                <table class="indent">
                                    <tr>
                                        ...
                                        <td style="width:35%" style="text-align:center;">
                                            <label class="radio-label" style="display: flex;" for="recessedmount">
                                                <span class="radio-item">
                                                    <input type="radio" id="cbustandard" ng-model="mount_type"
                                                        name="installtype" value="standard"
                                                        ng-checked="mount_type == 'standard'"
                                                        ng-change="mountTypeChange()" />
                                                </span>
                                                <img src="../prodconfigmedia/GuidedSell/CBU_Standard.png"
                                                    alt="CBU Standard" height="190" />
                                                <br />
                                                <span class="mountDescriptIndent"
                                                    style="float: right; text-align: left; margin:auto 0">3300 Series
                                                    Standard Cluster Box Units</span><br />
                                                <!-- <br /> -->
                                                <!-- <br /> -->
                                        ...
                                        <td style="width:35%">
                                            <label class="radio-label" style="display:flex;" for="surfacemount">
                                                <span class="radio-item">
                                                    <input type="radio" id="cburegency" ng-model="mount_type"
                                                        name="installtype" value="regency"
                                                        ng-checked="mount_type == 'regency'"
                                                        ng-change="mountTypeChange()" />
                                                    <span></span>
                                                </span>
                                                <img src="../prodconfigmedia/GuidedSell/CBU_Regency.png"
                                                    alt="Recessed Mounted" height="190" />
                                                <br />
                                                <span class="mountDescriptIndent"
                                                    style="float: right; text-align: left; margin:auto 0">3300R Series
                                                    Regency Decorative Cluster Box Units</span><br />
                                                <!--<span id="pedestalnote">(for USPS or private delivery)</span>-->
                                            </label>
                                        </td>
                                        <td style="width: 15%;"></td>
                                        ...
                                        <!-- <label class="radio-label" style="display:flex;" for="freemount">
                                            <span class="radio-item">
                                                <input type="radio" id="freemount" ng-model="mount_type" name="installtype" value="free" ng-checked="mount_type == 'free'" ng-disabled="loading_style === 'R'" ng-change="mountTypeChange()"/>
                                                <span></span>
                                            </span>
                                            <img src="../prodconfigmedia/GuidedSell/3700_4C_Unit_Icon-03.png" alt="Free Standing" height="190" />
                                            <br />
                                            <span class="mountDescriptIndent" style="float: right; text-align: left; margin:auto 0">3900 Series 4C<br />Free-Standing<br />Horizontal Mailboxes</span><br />
                                            <span id="pedestalnote">(for USPS or private delivery)</span>
                                        </label> -->
                                        <!-- </td> -->
                                        <!-- <td style="width:25%">
                        ...
                        <tr>
                            ...
                            <td class="questions" colspan="2"><b style="width: 160px;">What color do you want<br />your
                                    mailboxes to be?</b>
                                <table class="table table-condensed table-hover finish_type colorTable"
                                    ...
                                    <tr>
                                        ...
                                        <td ng-show="mount_type == 'standard'">
                                            <div style="white-space:nowrap;">
                                                <label>
                                                    <span class="radio-item">
                                                ...
                                                <label>Gray</label>
                                                <br />
                                                <span>(for replacement only)</span>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                ...
                angular.module('guidedSelling', ['trak.platform.client'])
                    .controller('guidedSellingCtrl', ['$scope', 'requestHandler', function ($scope, requestHandler) {
                        ...
                        requestHandler.execute("mbx_pc_guided_selling_process", params).success(function (d) {
                            ...
                            var cbu_model_id = "";
                            if ($scope.mount_type == "regency") {
                                cbu_model_id = "3126f96d-c144-476f-9a65-7052bdbd20a3";
                            }
                            else {
                                cbu_model_id = "920e9d40-4f70-4bd6-8688-d3be12372bb6";
                            }
                            var designerUrl = "modeldesigner.aspx?model_id=" + cbu_model_id + "&profile=mbxgs"
